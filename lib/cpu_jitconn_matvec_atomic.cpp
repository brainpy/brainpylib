...
namespace brainpy_lib {
    namespace {
        ...
        void matvec_atomic_prob_homo(void **out, const void **in) {
        ...
        template<typename T1>
        void matvec_atomic_prob_uniform(void **out, const void **in) {
            const T1 *vector = reinterpret_cast<const T1 *>(in[0]);
            const double log_p = *reinterpret_cast<const double *>(in[1]);
        ...
        template<typename T1>
        void matvec_atomic_prob_normal(void **out, const void **in) {
            const T1 *vector = reinterpret_cast<const T1 *>(in[0]);
            const double log_p = *reinterpret_cast<const double *>(in[1]);
    ...
    void matvec_atomic_prob_homo_float(void **out, const void **in){matvec_atomic_prob_homo<float>(out, in);}
    void matvec_atomic_prob_homo_double(void **out, const void **in){matvec_atomic_prob_homo<double>(out, in);}

    void matvec_atomic_prob_uniform_float(void **out, const void **in){matvec_atomic_prob_uniform<float>(out, in);}
    void matvec_atomic_prob_uniform_double(void **out, const void **in){matvec_atomic_prob_uniform<double>(out, in);}

    void matvec_atomic_prob_normal_float(void **out, const void **in){matvec_atomic_prob_normal<float>(out, in);}
    void matvec_atomic_prob_normal_double(void **out, const void **in){matvec_atomic_prob_normal<double>(out, in);}
