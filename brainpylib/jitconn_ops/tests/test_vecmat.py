...
class Test_vecmat_prob_conn(unittest.TestCase):
  ...
  def _test_homo(self, shape, transpose, prob, homo_data, seed=None):
    ...
    r1 = jitconn_ops.vecmat_prob_conn_homo_weight(vector,
                                                  homo_data,
                                                  conn_prob=prob,
                                                  shape=shape,
                                                  seed=seed,
    ...
    r2 = jitconn_ops.vecmat_prob_conn_homo_weight(vector,
                                                  homo_data,
                                                  conn_prob=prob,
                                                  shape=shape,
                                                  seed=seed,
  ...
  def _test_homo_vmap(self, shape, transpose, prob, seed=None):
    ...
    f1 = jax.vmap(lambda event, data: jitconn_ops.vecmat_prob_conn_homo_weight(
  ...
  def _test_homo_grad(self, shape, transpose, prob, seed=None):
    ...
    f1 = jax.grad(
      lambda event, data: jitconn_ops.vecmat_prob_conn_homo_weight(
  ...
  def _test_uniform(self, shape, transpose, prob, w_low, w_high, seed=None):
    ...
    r1 = jitconn_ops.vecmat_prob_conn_uniform_weight(events,
                                                     w_low=w_low,
                                                     w_high=w_high,
                                                     conn_prob=prob,
                                                     shape=shape,
    ...
    r2 = jitconn_ops.vecmat_prob_conn_uniform_weight(events,
                                                     w_low=w_low,
                                                     w_high=w_high,
                                                     conn_prob=prob,
                                                     shape=shape,
  ...
  def _test_uniform_vmap(self, shape, transpose, prob, seed=None):
    ...
    f1 = jax.vmap(lambda e: jitconn_ops.vecmat_prob_conn_uniform_weight(e,
                                                                        w_low=0.,
                                                                        w_high=1.,
                                                                        conn_prob=prob,
                                                                        shape=shape,
  ...
  def _test_uniform_grad(self, shape, transpose, prob, seed=None):
    ...
    f1 = jax.grad(
      lambda e: jitconn_ops.vecmat_prob_conn_uniform_weight(
        e,
        w_low=0.,
        w_high=1.,
        conn_prob=prob,
  ...
  def _test_normal(self, shape, transpose, prob, w_mu, w_sigma, seed=None):
    ...
    r1 = jitconn_ops.vecmat_prob_conn_normal_weight(events,
                                                    w_mu=w_mu,
                                                    w_sigma=w_sigma,
                                                    conn_prob=prob,
                                                    shape=shape,
    ...
    r2 = jitconn_ops.vecmat_prob_conn_normal_weight(events,
                                                    w_mu=w_mu,
                                                    w_sigma=w_sigma,
                                                    conn_prob=prob,
                                                    shape=shape,
  ...
  def _test_normal_vmap(self, shape, transpose, prob, seed=None):
    ...
    f1 = jax.vmap(lambda e: jitconn_ops.vecmat_prob_conn_normal_weight(e,
                                                                       w_mu=0.,
                                                                       w_sigma=1.,
                                                                       conn_prob=prob,
                                                                       shape=shape,
  ...
  def _test_normal_grad(self, shape, transpose, prob, seed=None):
    ...
    f1 = jax.grad(
      lambda e: jitconn_ops.vecmat_prob_conn_normal_weight(
        e,
        w_mu=0.,
        w_sigma=1.,
        conn_prob=prob,
