...
__all__ = [
  'event_matvec_v2_prob_conn_homo_weight',
  'event_matvec_v2_prob_conn_uniform_weight',
  'event_matvec_v2_prob_conn_normal_weight',
]


def event_matvec_v2_prob_conn_homo_weight(
    events: jnp.ndarray,
    weight: float,
    *,
    conn_prob: float,
...
def event_matvec_v2_prob_conn_uniform_weight(
    events: jnp.ndarray,
    *,
    w_low: float,
    w_high: float,
...
def event_matvec_v2_prob_conn_normal_weight(
    events: jnp.ndarray,
    *,
    w_mu: float,
    w_sigma: float,
...
event_matvec_prob_conn_homo_weight_p = Primitive('event_matvec_v2_prob_conn_homo_weight')
...
event_matvec_prob_conn_uniform_weight_p = Primitive('event_matvec_v2_prob_conn_uniform_weight')
...
event_matvec_prob_conn_normal_weight_p = Primitive('event_matvec_v2_prob_conn_normal_weight')
