...
ad.defjvp(csr_to_dense_p, _csr_todense_jvp, None, None)
ad.primitive_transposes[csr_to_dense_p] = _csr_todense_transpose
mlir.register_lowering(csr_to_dense_p, _csr_todense_lowering)
